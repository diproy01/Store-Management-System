                            ...
                            <table>
                                ...
                                */
                                ...
                                if (isset($_POST['Search']) AND trim($_POST['searchtxt']) != "") {
                                    ...
                                    $sql = "SELECT DISTINCT(transactionid) FROM  stock_sales WHERE stock_name LIKE '%" . $_POST['searchtxt'] . "%' OR customer_id LIKE '%" . $_POST['searchtxt'] . "%' OR supplier_name LIKE '%" . $_POST['searchtxt'] . "%' OR transactionid  LIKE '%" . $_POST['searchtxt'] . "%' OR date LIKE '%" . $_POST['searchtxt'] . "%' ORDER BY date desc LIMIT $start, $limit";

...
<head>
    <meta charset="utf-8">
    <title>ISOLUTION - Supplier</title>
                            ...
                            <table>
                                ...
                                */
                                ...
                                while ($row = mysqli_fetch_array($result)) {
									...
									$tot =0;
									$balance_query = "SELECT distinct(stock_id) FROM stock_entries WHERE stock_supplier_name = '".$row['supplier_name']."' AND balance>0";
									$balance = mysqli_query($db->connection, $balance_query);
									 while ($row_balance = mysqli_fetch_array($balance)) {
										 $balance_query2 = "SELECT balance FROM stock_entries WHERE stock_id = '".$row_balance['stock_id']."' LIMIT 1";

                        ...
                        <form name="deletefiles" action="delete.php" method="post">
                            ...
                            <table>
                                ...
                                if (isset($_POST['Search']) AND trim($_POST['searchtxt']) != "") {
                                    ...
                                    $SQL = "SELECT stock_id FROM  stock_entries WHERE stock_name LIKE '%" . $_POST['searchtxt'] . "%' OR stock_supplier_name LIKE '%" . $_POST['searchtxt'] . "%' OR stock_id LIKE '%" . $_POST['searchtxt'] . "%' OR date LIKE '%" . $_POST['searchtxt'] . "%' OR type LIKE '%" . $_POST['searchtxt'] . "%' AND type='entry'";
                                ...
                                */
                                ...
                                if (isset($_POST['Search']) AND trim($_POST['searchtxt']) != "") {
                                    ...
                                    $query = "SELECT COUNT(stock_id) as num FROM stock_entries WHERE stock_name LIKE '%" . $_POST['searchtxt'] . "%' OR stock_supplier_name LIKE '%" . $_POST['searchtxt'] . "%' OR stock_id LIKE '%" . $_POST['searchtxt'] . "%' OR date LIKE '%" . $_POST['searchtxt'] . "%' OR type LIKE '%" . $_POST['searchtxt'] . "%' and type='entry'";
                                ...
                                //$sql = "SELECT stock_id FROM stock_entries where type='entry' ORDER BY date desc LIMIT $start, $limit  ";
								$sql = "SELECT * FROM stock_entries where type='entry' ORDER BY date desc LIMIT $start, $limit  ";

                                if (isset($_POST['Search']) AND trim($_POST['searchtxt']) != "") {

                                   // $sql = "SELECT stock_id FROM stock_entries WHERE stock_name LIKE '%" . $_POST['searchtxt'] . "%' OR stock_supplier_name LIKE '%" . $_POST['searchtxt'] . "%' OR stock_id LIKE '%" . $_POST['searchtxt'] . "%' OR date LIKE '%" . $_POST['searchtxt'] . "%' OR type LIKE '%" . $_POST['searchtxt'] . "%' and type='entry' ORDER BY date desc LIMIT $start, $limit";
                                ...
                                */
                                ...
                                while ($row = mysqli_fetch_array($result)) {
									...
									//$line = $db->queryObject("SELECT * FROM stock_entries WHERE stock_id='$entryid' ");
									//$line = $db->queryObject("SELECT * FROM stock_entries WHERE stock_id='$entryid' ");
                                    //$mysqldate = $line->date;
										$mysqldate = $row['date'];
                                    ...
                                    <tr>
                                        ...
                                        <td width="100"><?php echo $line->stock_brand; ?></td>
                                        <td width="100"><?php echo $line->category; ?></td>
										...
										-->
										<td width="100"><?php echo $row['stock_id']; ?></td>
                                        <td width="100"><?php echo $row['stock_name']; ?></td>
                                        <td width="100"><?php echo $row['stock_brand']; ?></td>
                                        <td width="100"><?php echo $row['category'];?></td>
                                        <td width="100"><?php echo $row['quantity'];?></td>
                                        <td width="100"><?php echo $phpdate; ?></td>

                                        <td width="100"><?php echo $row['stock_supplier_name']; ?></td>
                                        <td width="100"><?php echo $row['subtotal']; ?></td>


                                        <td>
                                            <a href="update_purchase.php?sid=<?php echo $row['stock_id']; ?>&table=stock_entries&return=view_purchase.php"
                                               class="table-actions-button ic-table-edit">
                                            </a>
                                            <a onclick="return confirmSubmit()"
                                               href="delete.php?id=<?php echo isset($row['stock_id']) ? $row['stock_id'] : 0; ?>&name=<?php echo $row['stock_name']; ?>&brand=<?php echo $row['stock_brand']; ?>&table=stock_entries&return=view_purchase.php"

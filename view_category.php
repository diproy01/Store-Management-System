...
<head>
    <meta charset="utf-8">
    <title>ISOLUTION - Category View</title>
                                ...
                                */
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    <tr>
										...
										<td>
                                            &nbsp;<?php echo $age = $db->queryUniqueValue("SELECT sum(stock_quatity) FROM stock_details where category = '".$row['category_name']."' "); ?>
											</td>
                                    
										<td>
                                            &nbsp;<?php echo $age = $db->queryUniqueValue("SELECT sum(company_price) FROM stock_details where category = '".$row['category_name']."' "); ?>
											</td>

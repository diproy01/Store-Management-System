...
<head>
    <meta charset="utf-8">
    <title>ISOLUTION - Customer</title>
                            ...
                            <table>
                                ...
                                */
                                ...
                                while ($row = mysqli_fetch_array($result)) {
									$tot =0;
									$balance_query = "SELECT distinct(transactionid) FROM stock_sales WHERE customer_id = '".$row['id']."' AND customer = '".$row['customer_name']."'";
									$balance = mysqli_query($db->connection, $balance_query);
									 while ($row_balance = mysqli_fetch_array($balance)) {
										 $balance_query2 = "SELECT balance FROM stock_sales WHERE transactionid = '".$row_balance['transactionid']."' LIMIT 1";
										 $balance2 = mysqli_query($db->connection, $balance_query2);
									 $row_balance2 = mysqli_fetch_row($balance2);
									 $tot = $tot + $row_balance2[0];

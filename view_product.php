                        ...
                        <form name="deletefiles" action="delete.php" method="post">
                            ...
                            <table>
                                ...
                                if (isset($_POST['Search']) AND trim($_POST['searchtxt']) != "") {
                                    ...
                                    $SQL = "SELECT * FROM  stock_details WHERE stock_name LIKE '%" . $_POST['searchtxt'] . "%' OR category LIKE '%" . $_POST['searchtxt'] . "%' OR supplier_address LIKE '%" . $_POST['searchtxt'] . "%' OR supplier_id LIKE '%" . $_POST['searchtxt'] . "%' OR date LIKE '%" . $_POST['searchtxt'] . "%' ORDER BY id DESC";
                                ...
                                */
                                ...
                                if (isset($_POST['Search']) AND trim($_POST['searchtxt']) != "") {
                                    ...
                                    $query = "SELECT COUNT(*) as num FROM  stock_details WHERE stock_name LIKE '%" . $_POST['searchtxt'] . "%' OR category LIKE '%" . $_POST['searchtxt'] . "%' OR stock_id LIKE '%" . $_POST['searchtxt'] . "%' OR supplier_id LIKE '%" . $_POST['searchtxt'] . "%' OR date LIKE '%" . $_POST['searchtxt'] . "%'";
                                ...
                                if (isset($_POST['Search']) AND trim($_POST['searchtxt']) != "") {
                                    ...
                                    $sql = "SELECT * FROM  stock_details WHERE stock_name LIKE '%" . $_POST['searchtxt'] . "%' OR category LIKE '%" . $_POST['searchtxt'] . "%' OR stock_id LIKE '%" . $_POST['searchtxt'] . "%' OR supplier_id LIKE '%" . $_POST['searchtxt'] . "%' OR date LIKE '%" . $_POST['searchtxt'] . "%'  ORDER BY id DESC LIMIT $start, $limit";
                                ...
                                */
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['stock_brand']; ?></td>

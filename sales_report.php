...
if (!isset($_SESSION['username']) || $_SESSION['usertype'] != 'admin') { // if session variable "username" does not exist.
    ...
    if (isset($_GET['from_sales_date']) && isset($_GET['to_sales_date']) && $_GET['from_sales_date'] != '' && $_GET['to_sales_date'] != '') {
        ...
        error_reporting(0);
        $selected_date = $_GET['from_sales_date'].' 00:00:01';
        $selected_date = strtotime($selected_date);
        $mysqldate = date('Y-m-d H:i:s', $selected_date);
        $fromdate = $mysqldate;
        $selected_date = $_GET['to_sales_date'].' 23:59:59';
        $selected_date = strtotime($selected_date);
        $mysqldate = date('Y-m-d H:i:s', $selected_date);
		...
		<!--<a href="sales_excel_report.php">Download Excel</a>-->
		<!--<input name="excel" type="button" value="ExcelDownload" id="excelButton" onClick="printpage()">-->
                            ...
                            <td align="right">
                                <table width="300" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
                                        ...
                                        <td>
                                            &nbsp;<?php echo $t_profit = $db->queryUniqueValue("SELECT sum(profit) FROM stock_sales where date BETWEEN '$fromdate' AND '$todate' "); ?></td>
                                    </tr>
									<tr>
                                        <td><strong>Total Discount</strong></td>
                                        <td>
                                            &nbsp;<?php echo $t_discount = $db->queryUniqueValue("SELECT sum(dis_amount) FROM stock_sales where count1=1 AND date BETWEEN '$fromdate' AND '$todate' "); ?></td>
                                    </tr>
									<tr>
                                        <td><strong>Net Profit</strong></td>
                                        <td>
                                            &nbsp;<?php echo $n_profit = $t_profit - $t_discount; ?></td>
                                    </tr>
                                    <tr>
                            ...
                            <td>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    while ($line = $db->fetchNextObject($result)) {
										...
										$profi = $db->queryUniqueValue("SELECT sum(profit) FROM stock_sales where transactionid = '$transactionid' ");
										$net_profit = $profi - $dis_amount;
                                        ...
                                        <tr>
											...
											<td><?php echo $profi; ?></td>
											<td><?php echo $line->dis_amount; ?></td>

                        ...
                        <form name="deletefiles" action="delete.php" method="post">
                            ...
                            <table>
                                ...
                                */
                                ...
                                $query = "SELECT COUNT(DISTINCT stock_id) as num FROM $tbl_name where type LIKE 'entry%' and balance>0 ORDER BY id DESC";
                                if (isset($_POST['Search']) AND trim($_POST['searchtxt']) != "") {

                                    $query = "SELECT COUNT(DISTINCT stock_id) as num FROM stock_entries WHERE (stock_name LIKE '%" . $_POST['searchtxt'] . "%' OR stock_supplier_name LIKE '%" . $_POST['searchtxt'] . "%') and balance>0 AND type LIKE 'entry%' ORDER BY id DESC";
                                ...
                                $sql = "SELECT * FROM stock_entries where type LIKE 'entry%' and balance>0 GROUP BY stock_id ORDER BY date desc LIMIT $start, $limit   ";
                                if (isset($_POST['Search']) AND trim($_POST['searchtxt']) != "") {

                                    $sql = "SELECT * FROM stock_entries WHERE (stock_name LIKE '%" . $_POST['searchtxt'] . "%' OR stock_supplier_name LIKE '%" . $_POST['searchtxt'] . "%') AND type LIKE 'entry%' and balance>0 GROUP BY stock_id ORDER BY date desc LIMIT $start, $limit";

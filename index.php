...
<head>
    <meta charset="utf-8">
    <title>ISOLUTION - Login to Control Panel</title>
    ...
    <form action="checklogin.php" method="POST" id="login-form" class="cmxform" autocomplete="off">
        ...
        <fieldset>
            ...
            <p>
                ...
                <input type="text" id="login-username" class="round full-width-input" style="height: 30px;" placeholder="admin"
                       name="username" autofocus/>
            </p>

            <p>
                <label for="login-password">password</label>
                <input type="password" id="login-password" style="height: 30px;" name="password" placeholder="admin"
